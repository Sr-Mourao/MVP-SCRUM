        ...
        <v-sheet rounded="md" width="360" elevation="10">
            ...
            <perfect-scrollbar style="height: 400px">
                <v-list class="py-0 theme-list" lines="two">
                    <v-list-item value="valor" color="primary" class="py-4 px-8">
                        ...
                        <div>
                            <h6 class="text-subtitle-1 font-weight-bold mb-1">Title</h6>
                        </div>
                        <p class="text-subtitle-1 font-weight-regular textSecondary">subtitle</p>
                    </v-list-item>
                    <v-divider></v-divider>
                </v-list>
            </perfect-scrollbar>
