    ...
    <v-sheet width="360" elevation="10" rounded="md">
      ...
      <perfect-scrollbar style="height: 380px">
        <v-list class="pt-0 pb-5" lines="two">
          <v-list-item value="valor" color="primary" class="px-5 py-2">
            <h6 class="text-subtitle-1 font-weight-bold mb-1">TITLW</h6>
            <p class="text-subtitle-2 text-medium-emphasis">#HREF</p>
          </v-list-item>
        </v-list>
      </perfect-scrollbar>
    </v-sheet>
